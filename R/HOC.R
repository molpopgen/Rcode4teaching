...
#' @param gaussian If TRUE, HOC mutation model is N(0,sigmamu), else it is exp( lambda = 1/sigmamu ).
...
#' @export
HOC.VGVE.dist = function(N,mu,sigmaMU,sigmaE,sigmaS,ngens,nreps,gaussian=TRUE)
    {
      return(VGVEdistHOC(N,mu,sigmaMU,sigmaE,sigmaS,ngens,nreps,gaussian))
